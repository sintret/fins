...
public class TaskTask extends AsyncTask<String, String, JSONObject> {
    ...
    // constructor
    public TaskTask(Context context, String url, HashMap<String, String> params, Button button, ProgressDialog progressDialog, SessionManager session) {
        this.url = url;
        this.params = params;
        this._button = button;
